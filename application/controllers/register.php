...
class Register extends CI_Controller {
    ...
    public function register_user() {
        ...
        $this->form_validation->set_rules('email', 'Email', 
          'required|min_length[1]|max_length[255]|is_unique[register.user_email]| 
            valid_email');
        ...
        //$this->form_validation->set_rules('username','Username','required|is_unique[register.user_email]');
        // Begin validation
