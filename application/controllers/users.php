...
//Creating users
    public function new_user() {
        ...
        $this->form_validation->set_rules('is_active',  
          'Is Active', 'min_length[1]|max_length[1]| 
            integer|is_natural');
        // Begin validation
              ...
              $last_name = $row->last_name;
                ...
                $data['first_name'] = array('name' =>  
                  'first_name', 'id' => 'first_name',  
                    'value' => set_value('first_name', $first_name), 'maxlength' => '100', 'size' => '35');
                $data['last_name'] = array('name' =>  
                ...
                $data['email'] = array('name' => 'email',  
                  'id' => 'email', 'value' =>  
                    set_value('email', $email), 'maxlength'  
                      => '100', 'size' => '35');
                $data['is_active'] = array('name' =>  
                  'is_active', 'id' => 'is_active', 'checked'=> "(1 == 0) ? 'checked' : ''",
                    'value' => set_value('is_active',  
                      $is_active), 'maxlength'   => '100',  
                        'size' => '35');
